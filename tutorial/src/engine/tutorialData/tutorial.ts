...
import { holdTickNoteFall } from './segments/holdTickNote/fall.js'
import { holdTickNoteFrozen } from './segments/holdTickNote/frozen.js'
import { holdTickNoteHit } from './segments/holdTickNote/hit.js'
import { holdTickNoteIntro } from './segments/holdTickNote/intro.js'
...
const components = [initialization, stage, noteDisplay, connector] as const
